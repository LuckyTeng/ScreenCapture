...
public class FuzzyArrayAdapter<T> extends BaseAdapter implements Filterable, SpinnerAdapter {
    /**
     ...
     *                 instantiating views.
     */
    public FuzzyArrayAdapter(@NonNull Context context, int resource) {
     ...
     */
    public FuzzyArrayAdapter(@NonNull Context context, int resource, @NonNull T[] objects) {
     ...
     */
    public FuzzyArrayAdapter(@NonNull Context context, int resource,
                             int textViewResourceId, @NonNull T[] objects) {
...
//            mDropDownInflater = LayoutInflater.from(context);
    ...
    FuzzyArrayAdapter<CharSequence> createFromResource(@NonNull Context context,
                                                       int textArrayResId, @LayoutRes int textViewResId) {
